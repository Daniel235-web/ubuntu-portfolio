...
const SidebarMenuItem = ({
  ...
  return (
    ...
    >
      {isOpen && (
        <div className="absolute bottom-0.5 left-1/2 h-1.5 w-1.5 -translate-x-1/2 rounded-full bg-white md:bottom-auto md:left-0.5 md:top-1/2 md:h-1 md:w-1 md:-translate-y-1/2 md:translate-x-0" />
      )}
      <Image
        src={imageSrc}
        alt={title}
